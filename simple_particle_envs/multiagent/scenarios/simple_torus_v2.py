...
class Scenario(BaseScenario):
    def make_world(self, config, size=2.0, n_preds=3, pred_vel=0.9, prey_vel=1.0, discrete=True):
        ...
        world.equivariant = config.equivariant if hasattr(config, 'equivariant') else False
        world.torus = True
        world.dim_c = 2
        world.size = size
        ...
        print("World.Equivariant: " + str(world.equivariant))
        ...
        self.equivariant = world.equivariant
    ...
    def observation(self, agent, world):
        ...
        if agent.adversary and self.equivariant:
